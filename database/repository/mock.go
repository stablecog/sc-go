...
const MOCK_GENERATION_MODEL_ID = "986d447d-c38b-4218-a2c8-6e0b691f47ec"
const MOCK_SCHEDULER_ID = "6fb13b76-9900-4fa4-abf8-8f843e034a7f"
...
func (repo *Repository) CreateMockData(ctx context.Context) error {
	...
	_, err = repo.SetGenerationSucceeded(gen.ID.String(), "This is a prompt", "This is a prompt", "This is a negative prompt", "This is a negative prompt", false,
	...
	_, err = repo.SetGenerationSucceeded(gen.ID.String(), "This is a prompt 2", "This is a prompt 2", "", "", true, requests.CogWebhookOutput{
		Images: []requests.CogWebhookOutputImage{
			{
				Image: "output_4",
			},
...
func (repo *Repository) CreateMockGenerationForDeletion(ctx context.Context) (*ent.Generation, error) {
	...
	_, err = repo.SetGenerationSucceeded(gen.ID.String(), "to_delete", "to_delete", "", "", true, requests.CogWebhookOutput{
		Images: []requests.CogWebhookOutputImage{
			{
				Image: "output_4",
			},
...
func (repo *Repository) SetMockUsersUsernameNormalizedColumn(ctx context.Context, userID uuid.UUID, usernameNormalized string) error {
	// Set username_normalized for mock admin
