...
func TestGetUsersUniqueNegativePromptIds(t *testing.T) {
	...
	_, err = MockRepo.SetGenerationSucceeded(gen1.ID.String(), "TestGetUsersUniqueNegativePromptIds_1", "TestGetUsersUniqueNegativePromptIds_1", nil, requests.CogWebhookOutput{
	...
	_, err = MockRepo.SetGenerationSucceeded(gen2.ID.String(), "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", nil, requests.CogWebhookOutput{
		Images: []requests.CogWebhookOutputImage{{
			Image: "2.jpeg",
		}},
	}, 0)
	...
	_, err = MockRepo.SetGenerationSucceeded(gen3.ID.String(), "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", nil, requests.CogWebhookOutput{
		Images: []requests.CogWebhookOutputImage{{
			Image: "3.jpeg",
		}},
	}, 0)
