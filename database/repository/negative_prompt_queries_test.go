...
func TestGetUsersUniqueNegativePromptIds(t *testing.T) {
	// Create 2 prompts
	_, p1, err := MockRepo.GetOrCreatePrompts("TestGetUsersUniqueNegativePromptIds_1", "TestGetUsersUniqueNegativePromptIds_1", "TestGetUsersUniqueNegativePromptIds_1", "TestGetUsersUniqueNegativePromptIds_1", prompt.TypeImage, nil)
	assert.Nil(t, err)
	assert.NotNil(t, p1)
	_, p2, err := MockRepo.GetOrCreatePrompts("TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", prompt.TypeImage, nil)
	assert.Nil(t, err)
	assert.NotNil(t, p2)
	...
	_, err = MockRepo.SetGenerationSucceeded(gen1.ID.String(), "TestGetUsersUniqueNegativePromptIds_1", "TestGetUsersUniqueNegativePromptIds_1", "TestGetUsersUniqueNegativePromptIds_1", "TestGetUsersUniqueNegativePromptIds_1", true, requests.CogWebhookOutput{
	...
	_, err = MockRepo.SetGenerationSucceeded(gen2.ID.String(), "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", true, requests.CogWebhookOutput{
		Images: []requests.CogWebhookOutputImage{{
			Image: "2.jpeg",
		}},
	}, 0)
	...
	_, err = MockRepo.SetGenerationSucceeded(gen3.ID.String(), "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", "TestGetUsersUniqueNegativePromptIds_2", true, requests.CogWebhookOutput{
		Images: []requests.CogWebhookOutputImage{{
			Image: "3.jpeg",
		}},
	}, 0)
