		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{GenerationsColumns[23], GenerationsColumns[16]},
			},
			{
				Name:    "generation_user_id_status_created_at",
				Unique:  false,
				Columns: []*schema.Column{GenerationsColumns[23], GenerationsColumns[8], GenerationsColumns[16]},
			},
			{
				Name:    "generation_user_id_status",
				Unique:  false,
				Columns: []*schema.Column{GenerationsColumns[23], GenerationsColumns[8]},
			},
			{
