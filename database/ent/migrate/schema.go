		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{GenerationsColumns[28], GenerationsColumns[19]},
			},
			{
				Name:    "generation_user_id_status_created_at",
				Unique:  false,
				Columns: []*schema.Column{GenerationsColumns[28], GenerationsColumns[8], GenerationsColumns[19]},
			},
			{
				Name:    "generation_user_id_status",
				Unique:  false,
				Columns: []*schema.Column{GenerationsColumns[28], GenerationsColumns[8]},
			},
			{
