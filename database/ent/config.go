...
type (
	hooks struct {
		...
		GenerationOutputEmbed []ent.Hook
		GenerationOutputLike  []ent.Hook
	...
	inters struct {
		...
		GenerationOutputEmbed []ent.Interceptor
		GenerationOutputLike  []ent.Interceptor
