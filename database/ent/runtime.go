...
func init() {
	...
	credittypeDescCreatedAt := credittypeFields[5].Descriptor()
	...
	credittypeDescUpdatedAt := credittypeFields[6].Descriptor()
	...
	generationDescShouldSubmitToGallery := generationFields[10].Descriptor()
