...
func (c *RestAPI) HandleGetClipEmbeds(w http.ResponseWriter, r *http.Request) {
	...
	res, err := c.Milvus.Client.Search(c.Milvus.Ctx, database.MILVUS_COLLECTION_NAME, nil, "", []string{"image_path"}, vec2search, "image_embedding", entity.L2, 50, sp, client.WithSearchQueryConsistencyLevel(entity.ClSession))
	if err != nil {
