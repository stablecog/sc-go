...
func TestHandleQueryGenerationsDefaultParams(t *testing.T) {
	...
	assert.Equal(t, int32(30), genResponse[0].NumInferenceSteps)
	...
	assert.Equal(t, int32(30), genResponse[1].NumInferenceSteps)
	...
	assert.Equal(t, int32(30), genResponse[2].NumInferenceSteps)
	...
	assert.Equal(t, int32(30), genResponse[3].NumInferenceSteps)
