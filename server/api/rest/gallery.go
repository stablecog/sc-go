...
func (c *RestAPI) HandleSemanticSearchGallery(w http.ResponseWriter, r *http.Request) {
	...
	if search != "" {
		...
		// Get gallery data
		galleryDataUnsorted, err := c.Repo.RetrieveGalleryDataWithOutputIDs(outputIds, callingUserId, repository.GalleryDataFromGallery)
		if err != nil {
		...
		galleryData, nextCursorPostgres, nextOffsetPostgres, err = c.Repo.RetrieveMostRecentGalleryDataV3(filters, callingUserId, perPage, qCursor, qOffset, false)
		if err != nil {
