...
func TestHandleQueryUsersDefaultParams(t *testing.T) {
	...
	assert.Equal(t, float32(100), usersResponse.Users[1].Credits[0].RemainingAmount)
	assert.Equal(t, "mock", usersResponse.Users[1].Credits[0].CreditType.Name)
	assert.Equal(t, float32(1234), usersResponse.Users[1].Credits[1].RemainingAmount)
	...
	assert.Equal(t, float32(100), usersResponse.Users[2].Credits[0].RemainingAmount)
	...
	assert.Equal(t, float32(100), usersResponse.Users[3].Credits[0].RemainingAmount)
...
func TestHandleQueryUsersCursor(t *testing.T) {
	...
	assert.Equal(t, float32(100), usersResponse.Users[0].Credits[0].RemainingAmount)
	assert.Equal(t, "mock", usersResponse.Users[0].Credits[0].CreditType.Name)
	assert.Equal(t, float32(1234), usersResponse.Users[0].Credits[1].RemainingAmount)
