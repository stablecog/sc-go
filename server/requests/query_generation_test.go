...
func TestToQdrantFilters(t *testing.T) {
	...
	assert.Equal(t, "{\"must\":[{\"key\":\"model_id\",\"match\":{\"value\":\"49d75ae2-5407-40d9-8c02-0c44ba08f358\"}},{\"key\":\"scheduler_id\",\"match\":{\"value\":\"e07ad712-41ad-4ff7-8727-faf0d91e4c4e\"}},{\"key\":\"scheduler_id\",\"match\":{\"value\":\"c09aaf4d-2d78-4281-89aa-88d5d0a5d70b\"}},{\"key\":\"height\",\"range\":{\"gte\":6}},{\"key\":\"height\",\"range\":{\"lte\":7}},{\"key\":\"width\",\"range\":{\"gte\":1}},{\"key\":\"width\",\"range\":{\"lte\":5}},{\"key\":\"inference_steps\",\"range\":{\"gte\":2}},{\"key\":\"inference_steps\",\"range\":{\"lte\":3}},{\"key\":\"guidance_scale\",\"range\":{\"gte\":2}},{\"key\":\"width\",\"range\":{\"lte\":4}},{\"key\":\"gallery_status\",\"match\":{\"value\":\"approved\"}},{\"key\":\"gallery_status\",\"match\":{\"value\":\"not_submitted\"}},{\"key\":\"created_at\",\"range\":{\"gte\":1609459200}},{\"key\":\"is_favorited\",\"match\":{\"value\":true}},{\"key\":\"was_auto_submitted\",\"match\":{\"value\":true}}],\"must_not\":[{\"is_empty\":{\"key\":\"upscaled_image_path\"}}],\"should\":[{\"key\":\"height\",\"match\":{\"value\":512}},{\"key\":\"width\",\"match\":{\"value\":512}},{\"key\":\"width\",\"match\":{\"value\":768}},{\"key\":\"inference_steps\",\"match\":{\"value\":30}},{\"key\":\"guidance_scale\",\"match\":{\"value\":5}}]}", string(b))
}
...
func TestToQdrantFiltersIgnoreGalleryStatus(t *testing.T) {
	...
	// assert equal to prefined string
	assert.Equal(t, "{\"must\":[{\"key\":\"model_id\",\"match\":{\"value\":\"49d75ae2-5407-40d9-8c02-0c44ba08f358\"}},{\"key\":\"scheduler_id\",\"match\":{\"value\":\"e07ad712-41ad-4ff7-8727-faf0d91e4c4e\"}},{\"key\":\"scheduler_id\",\"match\":{\"value\":\"c09aaf4d-2d78-4281-89aa-88d5d0a5d70b\"}},{\"key\":\"height\",\"range\":{\"gte\":6}},{\"key\":\"height\",\"range\":{\"lte\":7}},{\"key\":\"width\",\"range\":{\"gte\":1}},{\"key\":\"width\",\"range\":{\"lte\":5}},{\"key\":\"inference_steps\",\"range\":{\"gte\":2}},{\"key\":\"inference_steps\",\"range\":{\"lte\":3}},{\"key\":\"guidance_scale\",\"range\":{\"gte\":2}},{\"key\":\"width\",\"range\":{\"lte\":4}},{\"key\":\"created_at\",\"range\":{\"gte\":1609459200}},{\"key\":\"is_favorited\",\"match\":{\"value\":true}},{\"key\":\"was_auto_submitted\",\"match\":{\"value\":true}}],\"must_not\":[{\"is_empty\":{\"key\":\"upscaled_image_path\"}}],\"should\":[{\"key\":\"height\",\"match\":{\"value\":512}},{\"key\":\"width\",\"match\":{\"value\":512}},{\"key\":\"width\",\"match\":{\"value\":768}},{\"key\":\"inference_steps\",\"match\":{\"value\":30}},{\"key\":\"guidance_scale\",\"match\":{\"value\":5}}]}", string(b))
}
