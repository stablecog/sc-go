...
// For custom images
const MAX_UPSCALE_INITIAL_WIDTH = 1024
const MAX_UPSCALE_INITIAL_HEIGHT = 1024
...
const FREE_CREDIT_AMOUNT_DAILY float32 = 8
...
const DEFAULT_GENERATE_PROMPT_STRENGTH float32 = 0.6
